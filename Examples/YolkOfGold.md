...
Location: Counting while comparing
RecipeLocation: Furniture
Index: Drawers where thing is always in the last opened
Description: Set of drawers where the item the player seeks is always in the last drawer they open, regardless of the order of opening.
For: Z-Machine
