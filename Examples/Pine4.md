...
Index: Pine 4. Flashback with multiple endings
Description: Pine: Adding a flashback scene that, instead of repeating endlessly, repeats only until the Princess has understood the point.
For: Z-Machine
