...
Index: Rope, able to be tied to things and dragged betwixt rooms
Description: A kind of rope which can be tied to objects and used to anchor the player or drag items from room to room.
For: Z-Machine
